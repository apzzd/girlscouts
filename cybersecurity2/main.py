...
def showunames(ev):
	if document['name'].value and document['age'].value and document['hobb'].value and document['anim'].value and document['color'].value and document['food'].value:
		...
		document['unames'] <= 'Usernames: ' + un1 + ' | ' + un2 + ' | ' + un3 + ' | ' + un4 + ' | ' + un5 + ' | ' + un6
	else:
		alert('You must fill out the form first')
...
def showpass(ev):
	...
	document['pass'] <= 'Passwords: ' + p1 + ' | ' + p2 + ' | ' + p3 + ' | ' + p4 + ' | ' + p5 + ' | ' + p6
...
document["shownamez"].bind("click", showunames)
document['showpass'].bind('click', showpass)
